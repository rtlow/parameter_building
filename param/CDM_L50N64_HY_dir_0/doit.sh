...
#SBATCH --job-name=CDM_L50N64_HY_dir_0
...
FINAL_SNAP="${OUTDIR}/CDM_L50N64_HY_dir_0/snap_127.hdf5"


# Modification is rarely needed
RESTART_DIR="${OUTDIR}/CDM_L50N64_HY_dir_0/restartfiles/"
JOBNAME=$SLURM_JOB_NAME
PARAM='CDM_L50N64_HY_dir_0.txt'
...
if [ -f "$FINAL_SNAP" ]; then
  ...
  ~/run-gen-pk-submit.sh "${OUTDIR}/CDM_L50N64_HY_dir_0/"
  sbatch ~/run-rockstar-dir.sh "${OUTDIR}/CDM_L50N64_HY_dir_0/"
else
