...
#SBATCH --job-name=2cDM_DREAMS116_DM_power00_sigma1_dir_4_Vkick100.00
...
FINAL_SNAP="${OUTDIR}/2cDM_DREAMS116_DM_power00_sigma1_dir_4_Vkick100.00/snap_127.hdf5"


# Modification is rarely needed
RESTART_DIR="${OUTDIR}/2cDM_DREAMS116_DM_power00_sigma1_dir_4_Vkick100.00/restartfiles/"
JOBNAME=$SLURM_JOB_NAME
PARAM='2cDM_DREAMS116_DM_power00_sigma1_dir_4_Vkick100.00.txt'
...
if [ -f "$FINAL_SNAP" ]; then
  ...
  ~/run-gen-pk-submit.sh "${OUTDIR}/2cDM_DREAMS116_DM_power00_sigma1_dir_4_Vkick100.00/"
  sbatch ~/run-rockstar-dir.sh "${OUTDIR}/2cDM_DREAMS116_DM_power00_sigma1_dir_4_Vkick100.00/"
else
