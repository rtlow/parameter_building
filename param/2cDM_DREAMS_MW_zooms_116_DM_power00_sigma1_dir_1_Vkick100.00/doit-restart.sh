...
#SBATCH --job-name=2cDM_DREAMS_MW_zooms_116_DM_power00_sigma1_dir_1_Vkick100.00
...
FINAL_SNAP="${OUTDIR}/2cDM_DREAMS_MW_zooms_116_DM_power00_sigma1_dir_1_Vkick100.00/snap_127.hdf5"
...
if [ -f "$FINAL_SNAP" ]; then
  ...
  ~/run-gen-pk-submit.sh "${OUTDIR}/2cDM_DREAMS_MW_zooms_116_DM_power00_sigma1_dir_1_Vkick100.00/"
  sbatch ~/run-rockstar-dir.sh "${OUTDIR}/2cDM_DREAMS_MW_zooms_116_DM_power00_sigma1_dir_1_Vkick100.00/"
else
