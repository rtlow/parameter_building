...
#SBATCH --job-name=CDM_L3N256_HY_dir_7
...
FINAL_SNAP="${OUTDIR}/CDM_L3N256_HY_dir_7/snap_007.hdf5"


# Modification is rarely needed
RESTART_DIR="${OUTDIR}/CDM_L3N256_HY_dir_7/restartfiles/"
JOBNAME=$SLURM_JOB_NAME
PARAM='CDM_L3N256_HY_dir_7.txt'
