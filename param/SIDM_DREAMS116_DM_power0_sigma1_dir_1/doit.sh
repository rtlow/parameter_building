...
#SBATCH --job-name=SIDM_DREAMS116_DM_power0_sigma1_dir_1
...
FINAL_SNAP="${OUTDIR}/SIDM_DREAMS116_DM_power0_sigma1_dir_1/snap_127.hdf5"


# Modification is rarely needed
RESTART_DIR="${OUTDIR}/SIDM_DREAMS116_DM_power0_sigma1_dir_1/restartfiles/"
JOBNAME=$SLURM_JOB_NAME
PARAM='SIDM_DREAMS116_DM_power0_sigma1_dir_1.txt'
...
if [ -f "$FINAL_SNAP" ]; then
  ...
  ~/run-gen-pk-submit.sh "${OUTDIR}/SIDM_DREAMS116_DM_power0_sigma1_dir_1/"
  sbatch ~/run-rockstar-dir.sh "${OUTDIR}/SIDM_DREAMS116_DM_power0_sigma1_dir_1/"
else
