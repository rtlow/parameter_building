...
#SBATCH --job-name=CDM_L3N256_DM_dir_0
...
FINAL_SNAP="${OUTDIR}/CDM_L3N256_DM_dir_0/snap_007.hdf5"


# Modification is rarely needed
RESTART_DIR="${OUTDIR}/CDM_L3N256_DM_dir_0/restartfiles/"
JOBNAME=$SLURM_JOB_NAME
PARAM='CDM_L3N256_DM_dir_0.txt'
