...
#SBATCH --job-name=2cDM_L25N256_DM_power00_sigma1_dir_5_Vkick71.88
...
FINAL_SNAP="${OUTDIR}/2cDM_L25N256_DM_power00_sigma1_dir_5_Vkick71.88/snap_007.hdf5"


# Modification is rarely needed
RESTART_DIR="${OUTDIR}/2cDM_L25N256_DM_power00_sigma1_dir_5_Vkick71.88/restartfiles/"
JOBNAME=$SLURM_JOB_NAME
PARAM='2cDM_L25N256_DM_power00_sigma1_dir_5_Vkick71.88.txt'
...
if [ -f "$FINAL_SNAP" ]; then
  ...
  sbatch ~/run-gen-pk-dir.sh "${OUTDIR}/2cDM_L25N256_DM_power00_sigma1_dir_5_Vkick71.88/"
else
