...
#SBATCH --job-name=CDM_DREAMS_MW_zooms_116_HY_dir_2
...
FINAL_SNAP="${OUTDIR}/CDM_DREAMS_MW_zooms_116_HY_dir_2/snap_127.hdf5"


# Modification is rarely needed
RESTART_DIR="${OUTDIR}/CDM_DREAMS_MW_zooms_116_HY_dir_2/restartfiles/"
JOBNAME=$SLURM_JOB_NAME
PARAM='CDM_DREAMS_MW_zooms_116_HY_dir_2.txt'
...
if [ -f "$FINAL_SNAP" ]; then
  ...
  ~/run-gen-pk-submit.sh "${OUTDIR}/CDM_DREAMS_MW_zooms_116_HY_dir_2/"
  sbatch ~/run-rockstar-dir.sh "${OUTDIR}/CDM_DREAMS_MW_zooms_116_HY_dir_2/"
else
