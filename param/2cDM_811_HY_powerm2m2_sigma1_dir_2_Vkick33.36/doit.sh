...
#SBATCH --job-name=2cDM_811_HY_powerm2m2_sigma1_dir_2_Vkick33.36
...
FINAL_SNAP="${OUTDIR}/2cDM_811_HY_powerm2m2_sigma1_dir_2_Vkick33.36/snap_127.hdf5"


# Modification is rarely needed
RESTART_DIR="${OUTDIR}/2cDM_811_HY_powerm2m2_sigma1_dir_2_Vkick33.36/restartfiles/"
JOBNAME=$SLURM_JOB_NAME
PARAM='2cDM_811_HY_powerm2m2_sigma1_dir_2_Vkick33.36.txt'
...
if [ -f "$FINAL_SNAP" ]; then
  ...
  ~/run-gen-pk-submit.sh "${OUTDIR}/2cDM_811_HY_powerm2m2_sigma1_dir_2_Vkick33.36/"
  sbatch ~/run-rockstar-dir.sh "${OUTDIR}/2cDM_811_HY_powerm2m2_sigma1_dir_2_Vkick33.36/"
else
