...
#SBATCH --job-name=CDM_DREAMS948_DM_dir_1
...
FINAL_SNAP="${OUTDIR}/CDM_DREAMS948_DM_dir_1/snap_127.hdf5"


# Modification is rarely needed
RESTART_DIR="${OUTDIR}/CDM_DREAMS948_DM_dir_1/restartfiles/"
JOBNAME=$SLURM_JOB_NAME
PARAM='CDM_DREAMS948_DM_dir_1.txt'
...
if [ -f "$FINAL_SNAP" ]; then
  ...
  ~/run-gen-pk-submit.sh "${OUTDIR}/CDM_DREAMS948_DM_dir_1/"
  sbatch ~/run-rockstar-dir.sh "${OUTDIR}/CDM_DREAMS948_DM_dir_1/"
else
