...
#SBATCH --job-name=2cDM_L3N256_DM_powerm2m2_sigma1_dir_9
...
FINAL_SNAP="${OUTDIR}/2cDM_L3N256_DM_powerm2m2_sigma1_dir_9/snap_007.hdf5"


# Modification is rarely needed
RESTART_DIR="${OUTDIR}/2cDM_L3N256_DM_powerm2m2_sigma1_dir_9/restartfiles/"
JOBNAME=$SLURM_JOB_NAME
PARAM='2cDM_L3N256_DM_powerm2m2_sigma1_dir_9.txt'
