...
# Job Name and Files
#SBATCH -J SIDM_L3N256_HY_powerm2_sigma1_dir_2
...
FINAL_SNAP="${OUTDIR}/SIDM_L3N256_HY_powerm2_sigma1_dir_2/snap_007.hdf5"


# Modification is rarely needed
RESTART_DIR="${OUTDIR}/SIDM_L3N256_HY_powerm2_sigma1_dir_2/restartfiles/"
JOBNAME=$SLURM_JOB_NAME
PARAM='SIDM_L3N256_HY_powerm2_sigma1_dir_2.txt'
...
mpiexec --mca opal_warn_on_missing_libcuda 0 \
       ...
       -np $SLURM_NTASKS ./Arepo $PARAM_PATH $RESTART > $LOG_PATH
