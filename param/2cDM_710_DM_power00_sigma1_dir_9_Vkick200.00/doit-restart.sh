...
#SBATCH --job-name=2cDM_710_DM_power00_sigma1_dir_9_Vkick200.00
...
FINAL_SNAP="${OUTDIR}/2cDM_710_DM_power00_sigma1_dir_9_Vkick200.00/snap_127.hdf5"


# Modification is rarely needed
RESTART_DIR="${OUTDIR}/2cDM_710_DM_power00_sigma1_dir_9_Vkick200.00/restartfiles/"
JOBNAME=$SLURM_JOB_NAME
PARAM='2cDM_710_DM_power00_sigma1_dir_9_Vkick200.00.txt'
...
if [ -f "$FINAL_SNAP" ]; then
  ...
  sbatch ~/run-gen-pk-dir.sh "${OUTDIR}/2cDM_710_DM_power00_sigma1_dir_9_Vkick200.00/"
else
