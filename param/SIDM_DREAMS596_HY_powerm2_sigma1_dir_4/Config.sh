...
SIDM_STATES=1                         #number of DM states (for inelastic models)
SIDM_REACTIONS=1                      #number of scatter reactions (for inelasitc models)
INDIVIDUAL_GRAVITY_SOFTENING=4+16+32  # bitmask with particle types where the softenig type should be chosen with that of parttype 1 as a reference type
