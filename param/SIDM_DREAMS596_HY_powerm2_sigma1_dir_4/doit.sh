...
#SBATCH --job-name=SIDM_DREAMS596_HY_powerm2_sigma1_dir_4
...
FINAL_SNAP="${OUTDIR}/SIDM_DREAMS596_HY_powerm2_sigma1_dir_4/snap_127.hdf5"


# Modification is rarely needed
RESTART_DIR="${OUTDIR}/SIDM_DREAMS596_HY_powerm2_sigma1_dir_4/restartfiles/"
JOBNAME=$SLURM_JOB_NAME
PARAM='SIDM_DREAMS596_HY_powerm2_sigma1_dir_4.txt'
...
if [ -f "$FINAL_SNAP" ]; then
  ...
  ~/run-gen-pk-submit.sh "${OUTDIR}/SIDM_DREAMS596_HY_powerm2_sigma1_dir_4/"
  sbatch ~/run-rockstar-dir.sh "${OUTDIR}/SIDM_DREAMS596_HY_powerm2_sigma1_dir_4/"
else
