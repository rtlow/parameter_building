...
#SBATCH --job-name=CDM_811_HY_dir_0
...
FINAL_SNAP="${OUTDIR}/CDM_811_HY_dir_0/snap_127.hdf5"


# Modification is rarely needed
RESTART_DIR="${OUTDIR}/CDM_811_HY_dir_0/restartfiles/"
JOBNAME=$SLURM_JOB_NAME
PARAM='CDM_811_HY_dir_0.txt'
...
if [ -f "$FINAL_SNAP" ]; then
  ...
  sbatch ~/run-gen-pk-dir.sh "${OUTDIR}/CDM_811_HY_dir_0/"
else
