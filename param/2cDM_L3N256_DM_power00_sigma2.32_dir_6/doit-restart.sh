...
#SBATCH --job-name=2cDM_L3N256_DM_power00_sigma2.32_dir_6
...
FINAL_SNAP="${OUTDIR}/2cDM_L3N256_DM_power00_sigma2.32_dir_6/snap_007.hdf5"


# Modification is rarely needed
RESTART_DIR="${OUTDIR}/2cDM_L3N256_DM_power00_sigma2.32_dir_6/restartfiles/"
JOBNAME=$SLURM_JOB_NAME
PARAM='2cDM_L3N256_DM_power00_sigma2.32_dir_6.txt'
