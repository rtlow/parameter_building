...
#SBATCH --job-name=CDM_DREAMS116_DM_dir_8
...
FINAL_SNAP="${OUTDIR}/CDM_DREAMS116_DM_dir_8/snap_127.hdf5"


# Modification is rarely needed
RESTART_DIR="${OUTDIR}/CDM_DREAMS116_DM_dir_8/restartfiles/"
JOBNAME=$SLURM_JOB_NAME
PARAM='CDM_DREAMS116_DM_dir_8.txt'
...
if [ -f "$FINAL_SNAP" ]; then
  ...
  ~/run-gen-pk-submit.sh "${OUTDIR}/CDM_DREAMS116_DM_dir_8/"
  sbatch ~/run-rockstar-dir.sh "${OUTDIR}/CDM_DREAMS116_DM_dir_8/"
else
