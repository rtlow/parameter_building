...
#SBATCH --job-name=SIDM_DREAMS948_DM_powerm2_sigma1_dir_5
...
FINAL_SNAP="${OUTDIR}/SIDM_DREAMS948_DM_powerm2_sigma1_dir_5/snap_127.hdf5"


# Modification is rarely needed
RESTART_DIR="${OUTDIR}/SIDM_DREAMS948_DM_powerm2_sigma1_dir_5/restartfiles/"
JOBNAME=$SLURM_JOB_NAME
PARAM='SIDM_DREAMS948_DM_powerm2_sigma1_dir_5.txt'
...
if [ -f "$FINAL_SNAP" ]; then
  ...
  ~/run-gen-pk-submit.sh "${OUTDIR}/SIDM_DREAMS948_DM_powerm2_sigma1_dir_5/"
  sbatch ~/run-rockstar-dir.sh "${OUTDIR}/SIDM_DREAMS948_DM_powerm2_sigma1_dir_5/"
else
