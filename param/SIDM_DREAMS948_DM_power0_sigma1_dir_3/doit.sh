...
#SBATCH --job-name=SIDM_DREAMS948_DM_power0_sigma1_dir_3
...
FINAL_SNAP="${OUTDIR}/SIDM_DREAMS948_DM_power0_sigma1_dir_3/snap_127.hdf5"


# Modification is rarely needed
RESTART_DIR="${OUTDIR}/SIDM_DREAMS948_DM_power0_sigma1_dir_3/restartfiles/"
JOBNAME=$SLURM_JOB_NAME
PARAM='SIDM_DREAMS948_DM_power0_sigma1_dir_3.txt'
...
if [ -f "$FINAL_SNAP" ]; then
  ...
  ~/run-gen-pk-submit.sh "${OUTDIR}/SIDM_DREAMS948_DM_power0_sigma1_dir_3/"
  sbatch ~/run-rockstar-dir.sh "${OUTDIR}/SIDM_DREAMS948_DM_power0_sigma1_dir_3/"
else
