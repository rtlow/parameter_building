...
#SBATCH --job-name=CDM_L3N512_DM_dir_1
...
FINAL_SNAP="${OUTDIR}/CDM_L3N512_DM_dir_1/snap_007.hdf5"


# Modification is rarely needed
RESTART_DIR="${OUTDIR}/CDM_L3N512_DM_dir_1/restartfiles/"
JOBNAME=$SLURM_JOB_NAME
PARAM='CDM_L3N512_DM_dir_1.txt'
